...
NOTES = [
    ...
    "다르면 다른 대역이 그려진다.",
    "가리키기 가장 쉬운 마크이기도 하다. 선은 2px 인데 대역은 면적이다.",
    "적합선 자체에는 <title> 을 안 준다. 점 무리를 지나는 선은 그림이 이미 뜻을 지고 있는 유일한 마크다. "
    "제목을 붙이면 독자가 보고 있는 것을 말하려고 차트마다 요소가 하나 늘고, 둘이 겹치는 자리에서 대역 대신 "
    "선이 포인터를 가져간다.",
